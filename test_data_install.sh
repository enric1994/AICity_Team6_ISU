...
mv ../../Deformable-ConvNets/data/data_Shuo/VOC1080/JPEGImages/test.txt ../../Deformable-ConvNets/dat$

mkdir ../../Deformable-ConvNets/output
mkdir ../../Deformable-ConvNets/output/rfcn_dcn_Shuo_AICity
mkdir ../../Deformable-ConvNets/output/rfcn_dcn_Shuo_AICity/resnet_v1_101_voc0712_rfcn_dcn_Shuo_AICit$
mkdir ../../Deformable-ConvNets/output/rfcn_dcn_Shuo_AICity/resnet_v1_101_voc0712_rfcn_dcn_Shuo_AICit$
mv rfcn_AICityVOC1080_FreezeCOCO_rpnOnly_all_withsignal-0004.params ../../Deformable-ConvNets/output/$
